...
const models: TsoaRoute.Models = {
  ...
  Package: {
    ...
    properties: {
      ...
      categoryType: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Trekking'] },
          { dataType: 'enum', enums: ['Expedition'] },
          { dataType: 'enum', enums: ['Tour'] },
        ],
        required: true,
      },
  ...
  Inquiry: {
    ...
    properties: {
      ...
      status: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['New'] },
          { dataType: 'enum', enums: ['Contacted'] },
          { dataType: 'enum', enums: ['Quote Sent'] },
          { dataType: 'enum', enums: ['Booked'] },
  ...
  Guide: {
    ...
    properties: {
      ...
      role: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Lead Expedition Leader'] },
          { dataType: 'enum', enums: ['Senior Trekking Guide'] },
          { dataType: 'enum', enums: ['High Altitude Sherpa'] },
          { dataType: 'enum', enums: ['Cultural Tour Guide'] },
        ],
        required: true,
      },
      ...
      status: {
        ...
        subSchemas: [
          ...
          { dataType: 'enum', enums: ['On Mountain'] },
          { dataType: 'enum', enums: ['On Leave'] },
        ],
        required: true,
      },
      phone: { dataType: 'string', required: true },
    ...
    properties: {
      ...
      paymentStatus: {
        ...
        subSchemas: [
          ...
          { dataType: 'enum', enums: ['Deposit Paid'] },
      ...
      bookingStatus: {
        ...
        subSchemas: [
          ...
          { dataType: 'enum', enums: ['In Review'] },
          { dataType: 'enum', enums: ['Active Trek'] },
      ...
      permitStatus: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Issued'] },
          { dataType: 'enum', enums: ['Processing'] },
          { dataType: 'enum', enums: ['Pending Document'] },
        ],
        required: true,
      },
  ...
  BlogArticle: {
    ...
    properties: {
      ...
      authorRole: { dataType: 'string', required: true },
      authorAvatar: { dataType: 'string', required: true },
      readTime: { dataType: 'string', required: true },
      status: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['Published'] },
          { dataType: 'enum', enums: ['Draft'] },
