...
export const seedDatabase = async () => {
  ...
  if (!existingAdmin) {
    ...
    console.log('Seeded admin: admin@alpineacetreks.com');
  } else {
  ...
  const defaultSettings = [
    ...
    { key: 'contactEmail', value: 'info@alpineacetreks.com' },
